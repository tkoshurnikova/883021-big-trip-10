...
/* harmony import */ var _controllers_point_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/point.js */ "./src/controllers/point.js");
/* harmony import */ var _models_card_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/card.js */ "./src/models/card.js");
...
const createEventTypeMarkup = (event, type) => {
  ...
  return (
    `<div class="event__type-item">
      ...
      <label class="event__type-label  event__type-label--${event}" for="event-type-${event}-1">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["uppercaseFirstLetter"])(event)}</label>
    </div>`
  );
};
...
const createCardEditTemplate = (card, options = {}, mode, destinations, allOffers) => {
  ...
  const eventGroups = Object.keys(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["EVENTS"]);
  const events = eventGroups.map((group) => createEventsFieldsetMarkup(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["EVENTS"][group], type)).join(`\n`);
      ...
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          <label class="event__label  event__type-output" for="event-destination-1">
            ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getEventTitle"])(type)}
          </label>
    ...
    ${destinations.getDestinationNames().map((item) => {
      return (
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formateDateAndTime"])(startDate)}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">
            To
          </label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formateDateAndTime"])(endDate)}">
        </div>
        ...
        ${mode === _controllers_point_js__WEBPACK_IMPORTED_MODULE_2__["Mode"].ADDING ? `` :
      ...
      ${(destination === `` && mode === _controllers_point_js__WEBPACK_IMPORTED_MODULE_2__["Mode"].ADDING) ? `` :
...
class CardEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  getData() {
    ...
    return new _models_card_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      'type': formData.get(`event-type`),
      'destination': destination,
      'date_from': moment__WEBPACK_IMPORTED_MODULE_5___default()(formData.get(`event-start-time`), `DD/MM/YY HH:mm`).valueOf(),
      'date_to': moment__WEBPACK_IMPORTED_MODULE_5___default()(formData.get(`event-end-time`), `DD/MM/YY HH:mm`).valueOf(),
  ...
  setRollUpButtonClickHandler(handler) {
    if (this._mode !== _controllers_point_js__WEBPACK_IMPORTED_MODULE_2__["Mode"].ADDING) {
  ...
  _setFlatpickrForStartDate(input, defaultDate) {
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(input, {
      enableTime: true,
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getEventTitle"])(type)} ${destination}</h3>

        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDateForDatetime"])(startDate)}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(startDate)}</time>
            &mdash;
            <time class="event__end-time" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDateForDatetime"])(endDate)}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(endDate)}</time>
          </p>
          <p class="event__duration">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getEventDuration"])(endDate, startDate)}</p>
        </div>
...
class Card extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(card) {
    super();
    this._card = card;
  }
...
class CardsList extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
  ...
  if (date !== ``) {
    return (
      `<span class="day__counter">${dayNumber}</span>
        <time class="day__date" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDateForDatetime"])(new Date(date))}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getMonth"])(new Date(date))} ${new Date(date).getDate()}</time>`
    );
  } else {
    return (``);
  }
...
class DayList extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const getFilteredCardsForStats = (cards) => {
  ...
  cardTypes.forEach((cardType) => {
    ...
    filteredCards.push({
      ...
      totalTime: filteredCardsByType.reduce((totalTime, item) => totalTime + moment__WEBPACK_IMPORTED_MODULE_2___default()(item.endDate).diff(moment__WEBPACK_IMPORTED_MODULE_2___default()(item.startDate), `hours`), 0),
      isTransport: _utils_common_js__WEBPACK_IMPORTED_MODULE_1__["EVENTS"].TRANSFER.some((item) => cardType === item)
    });
  });
...
const createTripInfoTemplate = (cards) => {
  ...
  const endMonth = (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getMonth"])(cards[0].startDate) === Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getMonth"])(cards[cards.length - 1].endDate)) ? `` : Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getMonth"])(cards[cards.length - 1].endDate);

  return (
    `<section class="trip-main__trip-info  trip-info">
      <div class="trip-info__main">
        <h1 class="trip-info__title">${route}</h1>
        <p class="trip-info__dates">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getMonth"])(cards[0].startDate)} ${cards[0].startDate.getDate()}&nbsp;&mdash;&nbsp;${endMonth} ${cards[cards.length - 1].endDate.getDate()}</p>
      </div>
...
class TripInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(cards) {
    super();
    this._cards = cards;
  }
...
class FilterController {
  constructor(container, cardsModel) {
    ...
    this._activeFilterType = _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"]).map((filterType) => {
      return {
        title: filterType,
        isDisabled: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["getCardsByFilter"])(this._cardsModel.getCards(), filterType).length === 0 ? true : false
      };
    });
...
/*!**********************************!*\
  !*** ./src/controllers/point.js ***!
  \**********************************/
/*! exports provided: Mode, EmptyCard, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class PointController {
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldCardComponent && oldCardEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._cardComponent, oldCardComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._cardEditComponent, oldCardEditComponent);
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(container, this._cardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.ADDING:
        if (oldCardComponent && oldCardEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldCardComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldCardEditComponent);
        }
        this._cardEditComponent = new _components_card_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._card, Mode.ADDING, this._destinations, this._offers);
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(container, this._cardEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._cardComponent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
    if (this._cardEditComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._cardEditComponent);
    }
  }
  ...
  _replaceCardToEdit() {
    this._onViewChange();
    this._cardEditComponent = new _components_card_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._card, Mode.EDIT, this._destinations, this._offers);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._cardEditComponent, this._cardComponent);
    this._mode = Mode.EDIT;
    this._setEditCardListeners();
  }

  _replaceEditToCard() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._cardComponent, this._cardEditComponent);
    this._mode = Mode.DEFAULT;
  ...
  _setEditCardListeners() {
    ...
    if (this._mode !== Mode.ADDING) {
      ...
      this._cardEditComponent.setFavoriteButtonClickHandler(() => {
        const newCard = _models_card_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(this._card);
...
/* harmony import */ var _components_cards_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/cards-list.js */ "./src/components/cards-list.js");
/* harmony import */ var _components_day_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/day-list.js */ "./src/components/day-list.js");
...
/* harmony import */ var _components_trip_info_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/trip-info.js */ "./src/components/trip-info.js");
...
class TripController {
  constructor(container, cardsModel, destinations, offers, api) {
    ...
    this._cardsListComponent = new _components_cards_list_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._noCardsComponent = new _components_no_cards_js__WEBPACK_IMPORTED_MODULE_3__["default"]();

    this._activeSortType = _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT;
  ...
  render() {
    ...
    if (doCardsExist) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(container, this._noCardsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
    }
  }
  ...
  _renderCards(cards) {
    ...
    const renderCardsByDays = () => {
      ...
      uniqueDates.forEach((uniqueDate) => {
        ...
        const day = new _components_day_list_js__WEBPACK_IMPORTED_MODULE_2__["default"](uniqueDate, uniqueDateNumber);

        sortedCardsByDate
        .filter((card) => card.startDate.getDate() === new Date(uniqueDate).getDate())
        .forEach((card) => {
          const pointController = new _point_js__WEBPACK_IMPORTED_MODULE_5__["default"](day, this._onDataChange, this._onViewChange, this._destinations, this._offers);
          pointController.render(card, _point_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
          pointControllers.push(pointController);
        });

        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(cardsListElement, day, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
      });
    ...
    if (!tripMain.querySelector(`.trip-info`)) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(tripMain, new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_4__["default"](sortedCardsByDate), _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
    }
  }
  ...
  createCard() {
    ...
    this._creatingCard = new _point_js__WEBPACK_IMPORTED_MODULE_5__["default"](cardsListElement, this._onDataChange, this._onViewChange, this._destinations, this._offers);
    this._creatingCard.render(_point_js__WEBPACK_IMPORTED_MODULE_5__["EmptyCard"], _point_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING);
  }
  ...
  _onSortTypeChange(sortType) {
    ...
    const cardsListElement = this._cardsListComponent.getElement();
    cardsListElement.innerHTML = ``;
    const dayBlockWithoutDate = new _components_day_list_js__WEBPACK_IMPORTED_MODULE_2__["default"](``, ``);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(cardsListElement, dayBlockWithoutDate, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);

    if (sortType === _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT) {
      this._renderCards(cards);
    } else {
      const pointControllers = [];
      const renderCardsWithoutDays = () => {
        sortedCards.forEach((card) => {
          const pointController = new _point_js__WEBPACK_IMPORTED_MODULE_5__["default"](dayBlockWithoutDate, this._onDataChange, this._onViewChange, this._destinations, this._offers);
          pointController.render(card, _point_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
          pointControllers.push(pointController);
        });
        return pointControllers;
  ...
  _onDataChange(pointController, oldData, newData) {
    if (oldData === _point_js__WEBPACK_IMPORTED_MODULE_5__["EmptyCard"]) {
      this._creatingCard = null;
      if (newData === null) {
        ...
        this._api.createCard(newData)
          .then((cardModel) => {
            ...
            pointController.render(cardModel, _point_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
...
/* harmony import */ var _models_cards_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/cards.js */ "./src/models/cards.js");
/* harmony import */ var _controllers_filter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/filter.js */ "./src/controllers/filter.js");
...
/* harmony import */ var _controllers_trip_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/trip.js */ "./src/controllers/trip.js");
/* harmony import */ var _models_destinations_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/destinations.js */ "./src/models/destinations.js");
/* harmony import */ var _models_offers_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/offers.js */ "./src/models/offers.js");
/* harmony import */ var _components_loading_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/loading.js */ "./src/components/loading.js");
...
const cardsModel = new _models_cards_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const destinationsModel = new _models_destinations_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const offersModel = new _models_offers_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
...
const statsComponent = new _components_stats_js__WEBPACK_IMPORTED_MODULE_4__["default"](cardsModel);
const cardsListSection = document.querySelector(`.trip-events`);
const loadingComponent = new _components_loading_js__WEBPACK_IMPORTED_MODULE_8__["default"]();

const tripContoller = new _controllers_trip_js__WEBPACK_IMPORTED_MODULE_5__["default"](cardsListSection, cardsModel, destinationsModel, offersModel, api);
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"](siteHeaderElement, cardsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(cardsListSection, loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(siteMainElement, statsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
statsComponent.hide();
...
siteMenuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].STATS:
      tripContoller.hide();
      statsComponent.show();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_3__["MenuItem"].TABLE:
      statsComponent.hide();
      tripContoller.show();
      break;
  }
...
class Cards {
  constructor() {
    this._cards = [];
    this._activeFilterType = _utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL;
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: EVENTS, formatTime, formatDate, formateDateAndTime, formatDateForDatetime, getEventDuration, getMonth, uppercaseFirstLetter, getEventTitle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formateDateAndTime", function() { return formateDateAndTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateForDatetime", function() { return formatDateForDatetime; });
...
const formatDateForDatetime = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date, moment__WEBPACK_IMPORTED_MODULE_0___default.a.HTML5_FMT.DATETIME_LOCAL);
};

const getEventDuration = (endDate, startDate) => {
  const a = moment__WEBPACK_IMPORTED_MODULE_0___default()(endDate);
  const b = moment__WEBPACK_IMPORTED_MODULE_0___default()(startDate);
...
const getMonth = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`MMM`);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: FilterType, getCardsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const isFutureDate = (date, today) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(today)) > 0;
};
